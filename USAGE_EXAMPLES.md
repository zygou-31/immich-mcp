...
```bash
# Check if server is running (will fail without auth)
curl -H "Authorization: Bearer your-secret-auth-token" http://localhost:8626/health

# Check API documentation
open http://localhost:8626/docs
```
